...
#### Пользователь переходит по ссылке и выбирает "Перевод" на встроенной клавиатуре.
#### Пользователь отправляет Боту текст для перевода.
#### Бот отправляет запрос с текстом на Веб-сервер переводчика и ожидает ответ.
#### Бот получает перевод с сервера и отправляет сообщение пользователю.
#### Конец.
